...
//	機能番号			関数名			引数				作業用バッファ
	...
	{F_FILE_TOGGLE_MD,				L"FileToggleMarkdown",	{VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},	VT_EMPTY,	nullptr}, //Markdown/テキストの切り替え
	{F_MD_LINK,						L"MdLink",				{VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},	VT_EMPTY,	nullptr}, //Markdownのリンクを仕込む／直す
	{F_MD_BOLD,						L"MdBold",				{VT_EMPTY, VT_EMPTY, VT_EMPTY, VT_EMPTY},	VT_EMPTY,	nullptr}, //Markdownの太字
